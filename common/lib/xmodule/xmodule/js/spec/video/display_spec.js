    ...
    describe('youtubeId', function() {
      ...
      describe('with speed', function() {
        return it('return the video id for given speed', function() {
          expect(this.video.youtubeId('0.75')).toEqual(this['7tqY6eQzVhE']);
          return expect(this.video.youtubeId('1.0')).toEqual(this['cogebirgzzM']);
        });
      });
      return describe('without speed', function() {
        return it('return the video id for current speed', function() {
          return expect(this.video.youtubeId()).toEqual(this.cogebirgzzM);
        });
      });
    });
