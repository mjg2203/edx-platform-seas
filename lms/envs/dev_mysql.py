...
FEATURES['ENABLE_INSTRUCTOR_BETA_DASHBOARD'] = False
...
MYSQL_HOST = ENV_TOKENS.get('MYSQL_HOST', 'localhost')
MYSQL_USER = ENV_TOKENS.get('MYSQL_USER', '')
MYSQL_DBNAME = ENV_TOKENS.get('MYSQLDB_NAME', 'edxapp')
MYSQL_PASSWORD = ENV_TOKENS.get('MYSQL_PASSWORD', '')

CVN_MYSQL_HOST = ENV_TOKENS.get('CVN_MYSQL_HOST', '')
CVN_MYSQL_USER = ENV_TOKENS.get('CVN_MYSQL_USER', '')
CVN_MYSQL_DB_NAME = ENV_TOKENS.get('CVN_MYSQL_DB_NAME', 'cvn')
CVN_MYSQL_PASSWORD = ENV_TOKENS.get('CVN_MYSQL_PASSWORD', '')
...
DATABASES = {
    ...
    'cvn_php': {
        "HOST": CVN_MYSQL_HOST,
        'ENGINE': 'django.db.backends.mysql',
        'NAME': CVN_MYSQL_DB_NAME,
        'USER': CVN_MYSQL_USER,
        'PASSWORD': CVN_MYSQL_PASSWORD,
    }
}
...
FEATURES['USE_XQA_SERVER'] = 'http://xqa:server@content-qa.mitx.mit.edu/xqa'
...
########################## PEARSON TESTING ###########################
FEATURES['ENABLE_PEARSON_LOGIN'] = False
